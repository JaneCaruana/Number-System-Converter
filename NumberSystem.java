...
b1.setFont (new Font ("Symbol", Font.BOLD, 16));
b2.setBounds(100,170,110,30);
b2.setBackground(Color.black);
b2.setForeground(Color.green);
b2.setFont (new Font ("Symbol", Font.BOLD, 16));
b3.setBounds(100,230,110,30);
b3.setBackground(Color.black);
b3.setForeground(Color.green);
b3.setFont (new Font ("Symbol", Font.BOLD, 16));
b4.setBounds(100,290,110,30);
b4.setBackground(Color.black);
b4.setForeground(Color.green);
b4.setFont (new Font ("Symbol", Font.BOLD, 16));
...
{  
   ...
   if(e.getSource()==b20)
      ...
      t1.setText("");
      System.out.println("Error message : There is nothing to delete ");
      }
    }
      if(temp==2){
         if(e.getSource()==b22)
